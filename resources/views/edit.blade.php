...
<div class="container-sm my-5">
    <form action="{{route('barang.update', ['barang' => $listbarangdb->id]) }}" method="POST">
        @csrf
        @method('put')
                    ...
                    <div class="p-5 bg-light rounded-3 border col-xl-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control @error('kode') is-invalid @enderror" type="text" name="kode" id="kode" value="{{ $errors->any() ? old('lastName') : $listbarangdb->kode_barang }}" placeholder="Enter kode">
                                @error('kode')
